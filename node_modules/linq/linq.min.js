...
new c},remove:function(b){b=this.compareSelector(b);var c=a(b);if(Object.prototype.hasOwnProperty.call(this.buckets,c))for(var d=this.buckets[c],e=0;e<d.length;e++)if(this.compareSelector(d[e].key)===b){this.entryList.remove(d[e]);d.splice(e,1);0==d.length&&delete this.buckets[c];this.countField--;break}},count:function(){return this.countField},toEnumerable:function(){var a=this;return new d(function(){var b;return new g(function(){b=a.entryList.first},function(){if(null!=b){var a={key:b.key,value:b.value};
b=b.next;return this.yieldReturn(a)}return!1},k)})}};return e}(),E=function(a){this.count=function(){return a.count()};this.get=function(b){return d.from(a.get(b))};this.contains=function(b){return a.contains(b)};this.toEnumerable=function(){return a.toEnumerable().select(function(a){return new y(a.key,a.value)})}},y=function(a,b){this.key=function(){return a};m.call(this,b)};y.prototype=new m;"function"===typeof define&&define.amd?define("linqjs",[],function(){return d}):typeof module!==x&&module.exports?
module.exports=d:B.Enumerable=d})(this);
