import { ComparerFn } from '../iterators/series-variable-window-iterator';
import { ISeries } from '../series';
export declare class SeriesVariableWindowIterable<IndexT, ValueT> implements Iterable<ISeries<IndexT, ValueT>> {
