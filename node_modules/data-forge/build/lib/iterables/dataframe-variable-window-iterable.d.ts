import { ComparerFn } from '../iterators/dataframe-variable-window-iterator';
import { IDataFrame } from '../dataframe';
export declare class DataFrameVariableWindowIterable<IndexT, ValueT> implements Iterable<IDataFrame<IndexT, ValueT>> {
